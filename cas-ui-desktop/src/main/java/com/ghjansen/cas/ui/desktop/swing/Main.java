...
public class Main {
	...
	public JFrame frame;
	public JSlider sliderRuleNumber;
	public JSlider sliderCells;
	public JSlider sliderIterations;
	...
	public JTextField txtRuleNumberValue;
	...
	private void initialize() {
		...
		txtRuleNumberValue = new JTextField();
		txtRuleNumberValue.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		txtRuleNumberValue.getDocument().addDocumentListener(new RuleNumberDocumentListener(em));
		txtRuleNumberValue.addFocusListener(new FocusAdapter() {
			@Override
			public void focusGained(FocusEvent e) {
				try {
					sliderRuleNumber.setValue(Integer.valueOf(txtRuleNumberValue.getText()));
				} catch (Exception ex) {
				}
			}
		...
		sliderRuleNumber = new JSlider(0, 255);
		sliderRuleNumber.addFocusListener(new FocusAdapter() {
			@Override
			public void focusGained(FocusEvent e) {
				em.transitionsEvent();
			}
		...
		sliderRuleNumber.setValue(0);
		sliderRuleNumber.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		sliderRuleNumber.addChangeListener(new ChangeListener() {
			@Override
			public void stateChanged(ChangeEvent ce) {
				txtRuleNumberValue.setText(sliderRuleNumber.getValue() + "");
		...
		gl_pnlRuleConfig.setHorizontalGroup(gl_pnlRuleConfig.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_pnlRuleConfig.createSequentialGroup()
						...
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(sliderRuleNumber, GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)
						.addComponent(txtRuleNumberValue, GroupLayout.DEFAULT_SIZE, 40, GroupLayout.PREFERRED_SIZE)
				)
		);
		gl_pnlRuleConfig.setVerticalGroup(gl_pnlRuleConfig.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlRuleConfig.createSequentialGroup()
						...
						.addGroup(gl_pnlRuleConfig.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_pnlRuleConfig.createSequentialGroup()
										.addComponent(lblRuleNumber))
								.addGroup(gl_pnlRuleConfig.createSequentialGroup()
										.addComponent(txtRuleNumberValue)
								)
								.addComponent(sliderRuleNumber)
						)
				)
		);
		...
		sliderCells = new JSlider(1, 1000);
		sliderCells.setValue(100);
		sliderCells.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		sliderCells.addChangeListener(new ChangeListener() {
			@Override
			public void stateChanged(ChangeEvent ce) {
				em.cellsEvent();
			}
		...
		sliderIterations = new JSlider(0, 1000);
		sliderIterations.setValue(1);
		sliderIterations.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		sliderIterations.addChangeListener(new ChangeListener() {
			@Override
			public void stateChanged(ChangeEvent ce) {
				em.iterationsEvent();
			}
		...
		gl_pnlLimits.setHorizontalGroup(gl_pnlLimits.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlLimits.createSequentialGroup()
						...
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_pnlLimits.createParallelGroup(Alignment.LEADING)
								.addComponent(sliderCells, GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
								.addComponent(sliderIterations, GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE))
						.addContainerGap())
		);
		gl_pnlLimits.setVerticalGroup(gl_pnlLimits.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlLimits.createSequentialGroup()
						.addContainerGap()
						.addGroup(gl_pnlLimits.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblCells)
								.addComponent(sliderCells, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_pnlLimits.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblIterations)
								.addComponent(sliderIterations, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
		...
		btnSimulateComplete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				em.executeComplete();
				sliderRuleNumber.grabFocus();
				em.simulationController.getSimulation().setActive(false);
//				em.setActivityState(ActivityState.CONFIGURING_RULE);
			}
		});
